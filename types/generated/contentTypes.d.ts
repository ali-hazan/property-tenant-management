...
export interface ApiAgrementAgrement extends Schema.CollectionType {
...
export interface ApiLeaseLease extends Schema.CollectionType {
  ...
  attributes: {
    leaseId: Attribute.String & Attribute.Required & Attribute.Unique;
    startDate: Attribute.Date & Attribute.Required;
    endDate: Attribute.Date & Attribute.Required;
    rentAmount: Attribute.Decimal & Attribute.Required;
    securityDeposit: Attribute.Decimal;
    status: Attribute.Enumeration<['active', 'terminated']> &
      Attribute.Required &
      Attribute.DefaultTo<'active'>;
    agrement: Attribute.Relation<
      'api::lease.lease',
      'manyToOne',
      'api::agrement.agrement'
    >;
    paymentType: Attribute.Enumeration<['recurring', 'one_time']> &
      Attribute.Required &
      Attribute.DefaultTo<'recurring'>;
    paymentDueDate: Attribute.Date;
...
export interface ApiMaintenanceRequestMaintenanceRequest
  ...
  attributes: {
    ...
    status: Attribute.Enumeration<
      ['under_review', 'scheduled', 'in_progress', 'completed', 'rejected']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'under_review'>;
    requestedDate: Attribute.Date & Attribute.Required;
...
export interface ApiPaymentPayment extends Schema.CollectionType {
  ...
  attributes: {
    paymentRef: Attribute.String;
    amount: Attribute.Decimal & Attribute.Required;
    date: Attribute.Date & Attribute.Required;
    status: Attribute.Enumeration<['made', 'failed', 'in_progress']> &
      Attribute.Required;
...
export interface ApiPropertyProperty extends Schema.CollectionType {
  ...
  attributes: {
    ...
    address: Attribute.String & Attribute.Required;
    status: Attribute.Enumeration<
      ['occupied', 'vacant', 'construction', 'maintenance']
    >;
    type: Attribute.Enumeration<
      ['commercial', 'partion', 'flatmate', 'villa', 'flat']
    >;
    numberOfTenant: Attribute.Integer & Attribute.Required;
...
export interface ApiTanantTanant extends Schema.CollectionType {
  collectionName: 'tanants';
  info: {
    singularName: 'tanant';
    pluralName: 'tanants';
    displayName: 'tanant';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::tanant.tanant': ApiTanantTanant;
    }
  }
}
